                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="grid grid-rows-[20%_50%_30%]">
                            ...
                            <div className="mx-auto mt-6">
                                <TextField onChangeCapture={(newData)=>setData({...data,picture:newData.target.value})} label="Picture" name="picture" id="picture" variant="outlined" InputProps={{ sx: { borderRadius: 5, height: 50, width: 170 } }} value={imgData} onChange={handleImg} />
                            </div>
                        </div>
