...
export default function AddProduct({ className: className }: Props) {
    ...
    //state of showing the AddProduct pop-up page
    ...
    //change the data and the type of art from the form
    ...
    //when press add button, it will add the product to the database as a JSON
    const handleSubmit = () => {
